...
'packages/modules/Permission	https://android.googlesource.com/platform/packages/modules/Permission	aosp	refs/tags/android-12.0.0_r26	https://github.com/rinando/android_packages_Permissions	rinando	lineage-19.0	rebase'
'external/boringssl		https://android.googlesource.com/platform/external/boringssl	aosp	refs/tags/android-12.0.0_r26	https://github.com/rinando/android_external_boringssl	rinando	lineage-19.0	rebase'
...
'system/libhidl			https://android.googlesource.com/platform/system/libhidl	aosp    refs/tags/android-12.0.0_r26	https://github.com/rinando/android_system_libhidl	rinando	lineage-19.0	rebase'
'system/netd			https://github.com/lineageos/android_system_netd		aosp	refs/tags/android-12.0.0_r26	https://github.com/rinando/android_system_netd			rinando	lineage-19.0	rebase'
'system/bpf			https://android.googlesource.com/platform/system/bpf		aosp	refs/tags/android-12.0.0_r26	https://github.com/rinando/android_system_bpf			rinando	lineage-19.0	rebase'

'hardware/broadcom/wlan		https://android.googlesource.com/platform/hardware/broadcom/wlan		github	refs/tags/android-12.0.0_r26	https://github.com/rinando/android_hardware_broadcom_wlan	rinando	lineage-19.0	checkout'
...
'hardware/ril			https://github.com/lineageos/android_hardware_ril		aosp	refs/tags/android-12.0.0_r26	https://github.com/rinando/android_hardware_ril			rinando	lineage-19.0	rebase'
