...
'art				https://android.googlesource.com/platform/art			aosp	refs/tags/android-13.0.0_r13	https://github.com/rinando/android_art				rinando	lineage-20.0	rebase'
'external/perfetto			https://android.googlesource.com/platform/external/perfetto	aosp	refs/tags/android-13.0.0_r13	https://github.com/rinando/android_external_perfetto	rinando	lineage-20.0	rebase'

# Disable BPF features
'system/bpf			https://android.googlesource.com/platform/system/bpf		aosp	refs/tags/android-13.0.0_r13	https://github.com/rinando/android_system_bpf			rinando	lineage-20.0	rebase'
'system/netd			https://github.com/lineageos/android_system_netd		aosp	refs/tags/android-13.0.0_r13	https://github.com/rinando/android_system_netd			rinando	lineage-20.0	rebase'
'frameworks/libs/net		https://android.googlesource.com/platform/frameworks/libs/net 		aosp	refs/tags/android-13.0.0_r13	https://github.com/rinando/android_frameworks_libs_net		rinando	lineage-20.0	rebase'
...
'packages/modules/NetworkStack			https://android.googlesource.com/platform/packages/modules/NetworkStack		aosp	refs/tags/android-13.0.0_r13	https://github.com/rINanDO/android_packages_modules_NetworkStack			rinando	lineage-20.0	rebase'

# Binder threadpool shrink
'system/libhwbinder                            https://android.googlesource.com/platform/system/libhwbinder                    aosp    refs/tags/android-13.0.0_r13    https://github.com/rinando/android_system_libhwbinder                   rinando lineage-20.0 rebase'
...
# Fix bluetooth audio
'packages/modules/Bluetooth                            https://android.googlesource.com/platform/packages/modules/Bluetooth                    github	lineage-20.0    https://github.com/rinando/android_packages_modules_bluetooth                   rinando lineage-20.0 rebase'
)
