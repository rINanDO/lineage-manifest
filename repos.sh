...
'packages/modules/Permission	https://github.com/lineageos/android_packages_modules_Permission	github	lineage-19.1	https://github.com/rinando/android_packages_Permissions			rinando	lineage-19.1	rebase'
